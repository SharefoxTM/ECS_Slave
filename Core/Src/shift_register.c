...
#define cycleLatch() cyclePinLow(SR_Latch_GPIO_Port, SR_Latch_Pin)
#define cycleClock() cyclePinHigh(SR_CLK_GPIO_Port, SR_CLK_Pin)
...
uint8_t ShiftRegister_DetectSlots(ShiftRegister_t *sr) {
	...
	SR_Latch_GPIO_Port->BRR = SR_Latch_Pin;
